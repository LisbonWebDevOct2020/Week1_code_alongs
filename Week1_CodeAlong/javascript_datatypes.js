...
// console log firstName and lastName -> visible on the same line (use one console.log)

//old fashioned way of string interpolation
...
// Hello "name" and my age is "yourage"
...
// Write the code that finds the index of the letter 'j' in "My favorite dessert is jello"
console.log("My favorite dessert is jello".indexOf('j'));

// Substring
let withSubstring = message.substring(0, 3); //substr
